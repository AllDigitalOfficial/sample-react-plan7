              ...
              <div className="col">
                ...
                >
                  ...
                  <p className="fs-4 fw-bold" style={{ color: referralAmountColor }}>
                    {referralAmount} <span style={{ color: textColor }}>BNB</span>
                  </p>
                </div>
              </div>
              ...
              <div className="col">
                ...
                >
                  ...
                  <p className="fs-4 fw-bold" style={{ color: userDividendsColor }}>
                    {userDividends} <span style={{ color: textColor }}>BNB</span>
                  </p>
                </div>
              </div>
              ...
              <div className="col">
                ...
                >
                  ...
                  <p className="fs-4 fw-bold" style={{ color: withdrawableBalanceColor }}>
                    {withdrawableBalance} <span style={{ color: textColor }}>BNB</span>
                  </p>
                  <button
